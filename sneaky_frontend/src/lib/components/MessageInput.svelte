  ...
  {#if selectedFile}
    <div class="space-y-3">
      <div class="relative">
        ...
        <button
          type="button"
          class="absolute top-2 right-2 p-1 bg-red-500 text-white rounded-full hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
      ...
      <input
        ...
        <div class="flex items-center space-x-1 sm:space-x-2">
          ...
          <div class="flex items-center group">
            <div class="p-2 bg-yellow-50 rounded-lg border border-yellow-200 shadow-sm flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 text-yellow-600" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span class="font-medium text-sm text-yellow-800">{coins}</span>
              {#if coins === 0}
                <button
                  type="button"
                  class="ml-1 p-1 text-indigo-600 hover:text-indigo-800 focus:outline-none transition-colors"
          ...
          <button
            type="button"
            class="p-2 {isAnonymous ? 'text-indigo-600' : 'text-gray-500'} hover:text-indigo-600 focus:outline-none focus:text-indigo-600 transition-colors relative group"
          ...
          <button
            ...
            class="p-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
